...
public class main {
    public static void main(String[] args) {
        ...
        SimplePrinter printer1 = new SimpleConsolePrinter();
        printer1.print("Hola mundo simple");

        SimplePrinter printer2 = new AdapterPrinter(new DetailedPrinter(), "Valentina");

        printer2.print("Hola mundo detallado");
    }
}
